...
public final class NotesContract {
    ...
    static final String AUTHORITY = "com.nsu.notepad.provider";
    private static final String URI = "content://" + AUTHORITY;

    static final String[] CREATE_DATABASE_QUERIES = {
            Notes.CREATE_TABLE,
    ...
    public static abstract class Notes implements BaseColumns {
        ...
        static final String URI_TYPE_NOTE_DIR = "vnd.android.cursor.dir/vnd.nsu.note";
        static final String URI_TYPE_NOTE_ITEM = "vnd.android.cursor.item/vnd.nsu.note";
    ...
    public static abstract class Images implements BaseColumns {
        ...
        static final String URI_TYPE_IMAGE_DIR = "vnd.android.cursor.dir/vnd.nsu.image";
        static final String URI_TYPE_IMAGE_ITEM = "vnd.android.cursor.item/vnd.nsu.image";
    }
}
